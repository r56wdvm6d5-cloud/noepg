...
class MultiXMLProcessor:
    ...
    def create_combined_xml(self) -> ET.Element:
        ...
        root.set('generator-info-name', 'Multi-XML-Processor-TimeFiltered')
        root.set('generator-info-url', 'https://github.com/r56wdvm6d5-cloud/epguk')
        root.set('source-info-name', 'Multi-Source-EPG-TimeFiltered')
...
def main():
    """Main function."""
    parser = argparse.ArgumentParser(description='Process multiple XML sources into one EPG file with time filtering')
    parser.add_argument('--config', '-c', default='multi_xml_config_timefiltered.txt', 
