...
class MultiXMLProcessor:
    ...
    def __init__(self):
        ...
        self.max_programs_per_channel = 100
        self.current_time = datetime.now(timezone.utc)  # Current UTC time for checking  # Early limiting for faster loading
...
def main():
    ...
    parser.add_argument('--config', '-c', default='DOC2/tvshow_multi_xml_config.txt', 
