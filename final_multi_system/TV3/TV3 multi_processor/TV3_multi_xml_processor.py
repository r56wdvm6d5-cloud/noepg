...
class TV3MultiXMLProcessor:
    ...
    def create_combined_xml(self) -> ET.Element:
        ...
        root.set('generator-info-name', 'TV3-Multi-XML-Processor')
        root.set('generator-info-url', 'https://github.com/r56wdvm6d5-cloud/epguk')
        root.set('source-info-name', 'TV3-Source-EPG')
...
def main():
    ...
    parser.add_argument('--config', '-c', default='TV3_multi_xml_config.txt', 
    ...
    processor = TV3MultiXMLProcessor()
